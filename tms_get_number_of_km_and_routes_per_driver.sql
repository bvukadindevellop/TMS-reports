-- Broj kilometara i ruta po mesecima po vozacu
drop function if exists tms_get_number_of_km_and_routes_per_driver ();

create or replace function tms_get_number_of_km_and_routes_per_driver
(
driv_id int
)
...
and t_working_order.driver_id = driv_id
...
--SELECT * FROM tms_get_number_of_km_and_routes_per_driver(1)