...
drop function if exists tms_get_number_of_km_and_routes_per_vehicle ();

create or replace function tms_get_number_of_km_and_routes_per_vehicle
(
veh_id int
)
...
and t_working_order.vehicle_id = veh_id
...
--SELECT * FROM tms_get_number_of_km_and_routes_per_vehicle(101626)